...
You can install or update the NuGet packages for OData Web API 5.4 RC using the [Package Manager Console](http://docs.nuget.org/docs/start-here/using-the-package-manager-console):
